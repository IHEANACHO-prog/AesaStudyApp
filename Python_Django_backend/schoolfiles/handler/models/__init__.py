...
from .school_details.lecturenote import LectureNote
from .school_details.mediaresource import MediaResource
from .school_details.selfassessment import SelfAssessmentQuestion, SelfAssessmentOption, SelfAssessmentAttempt